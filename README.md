...
* **synthetic_data**: this directory contains a batch of synthesized images that were generated using the $G^{i}_{0}$ distribution with different values of the alpha and gamma parameters. ![Synthetic SAR image generation parameters](https://github.com/user-attachments/assets/7f2b3f52-cc8d-4e80-b271-a9435a48dc02)
